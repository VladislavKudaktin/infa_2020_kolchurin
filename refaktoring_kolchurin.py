...
for coord in coil_coord:
    # clew клубок
    circle(screen, (153, 153, 153), (coord[0], coord[1]), (coord[1]//12))
    circle(screen, (78, 45, 21), (coord[0], coord[1]), (coord[1]//12), 1)
    i = 120
    j = 80
    # lines on the clew
    ...
    arc(screen, (78, 45, 21), (coord[0] - 55, coord[1] - 40, i, j), 1, pi/2)
    arc(screen, (78, 45, 21), (coord[0] - 65, coord[1] - 20, i, j), 7, pi/2)
#_________________________________________________________________________
